...
export default function AgentProperties() {
  const steps = [
    ...
    // STEP 4 — Another form
    {
      ...
      questSubtitle:"Make your listing stand out by sharing what’s nearby—shops, schools, parks, or public transport. The right details can help attract the perfect tenant!",  
      fields: [
  ...
  const handleNext = () => {
    ...
    else console.log("Final Answers:", answers, formData);
  };
          ...
          <div className="flex flex-col min-h-screen bg-gray-50 items-center py-8 px-4">
            <div className="w-full max-w-3xl">
              {current.type === "options" ? (
                ...
                <AmenityStep question={current.question}
                  questSubtitle={current.questSubtitle}
                  fields={current.fields}  />
              ) : current.type === "image"? (
                <ImageStep  question={current.question}
                  questSubtitle={current.questSubtitle}
                  fields={current.fields} description={current.description} propertyType={current.propertyType} address={current.address}
                  formData={formData}
                   />
              ): (<div></div>)}
              ...
              <div className="flex justify-between mt-10">
                ...
                <button
                  onClick={handleNext}
                  className="px-6 py-2 rounded-full bg-blue-800 text-white hover:bg-blue-900 transition"
                >
