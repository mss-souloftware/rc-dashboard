                    ...
                    <div className="w-full flex items-center justify-between mt-5">
                        ...
                        <div className="flex items-center gap-3 bg-white p-1.5 rounded-lg">
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium border transition ${activeTab === "saved"
                            ...
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg text-sm font-medium border transition ${activeTab === "upcoming"
                                    ? "border border-[#DBE0EA] bg-[#F8F9FC] text-gray-900"
                                    : "bg-transparent border-transparent text-gray-600 hover:text-gray-800"
                                    }`}
                            >
