...
export default function PriceStep({ question, questSubtitle, fields }) {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-7 w-full my-15 space-y-8">
      <div className="flex flex-col gap-5 text-center md:text-left align-center mx-5 md:mx-0 md:align-start md:w-xl ">
        <h2 className="text-xl sm:text-4xl font-semibold text-gray-800">
          {question}
        </h2>
        <p className="text-gray-500 text-lg">{questSubtitle}</p>
        <div>
      ...
      <div className="w-[400px] h-[500px] overflow-hidden rounded-2xl shadow-md">
        <Image
          src="/global/finished.png"
          alt="Property1"
          width={300}
          height={600}
