...
export default function ApplicationsTable() {
  return (
    <div className="bg-white rounded-xl border border-[#DBE0EA] p-5 w-full">
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y">
            {applications.map((app) => (
              <tr
                key={app.id}
                className="hover:bg-gray-50 odd:bg-gray-50 border border-[#EAEAF0] border-r-0 border-l-0"
              >
                <td className="py-3">
      ...
      <div className="md:hidden space-y-4">
        {applications.map((app) => (
          <div
            key={app.id}
            className="border border-[#EAEAF0] rounded-lg p-4 shadow-sm"
          >
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">$650 / week</p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                <Image
                  ...
                  className="rounded-full"
                />
                <span className="text-sm">Antoni Francki</span>
              </div>

              <SquarePen className="w-4 h-4 text-[#323C65]" />
            </div>
      ...
      <div className="flex justify-between items-center mt-4">
        <button className="text-blue-600 text-sm underline">See all</button>
        <div className="flex items-center gap-2">
